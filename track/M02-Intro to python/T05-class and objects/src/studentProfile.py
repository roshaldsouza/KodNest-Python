class StudentProfile:
    def __init__(self, student_id, name, course, score, skills=None, is_placed=False):
    ...
    def __str__(self):
        ...
        return f"{self.student_id} | {self.name} | {self.course} | {self.score} | {skills_text} | {placement_text}"
